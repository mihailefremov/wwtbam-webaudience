	...
	<main role="main" class="container">
	   ...
	   for ($x = 1; $x <= $total/10; $x++) {
			...
			for ($y = 1; $y <= 10; $y++) {
				$index = $index + 1;
				$color = "plain";
				if (checkifuseractive('ag'.$index, 2, 1)){
					$color = "red";
				}
				
				echo "<div class='col-md-1'>
					<button type='submit' name='sbmt' value='$index' id='audButton' style='background-color:$color' class='btn btn-lg btn-block' data-toggle='modal' data-target='#exampleModal$index'>
					   <h1 style='font-size:1.0em' id='ans1set' >$index</h1>
					</button>
				 </div>";
					  ...
					  <div class='modal-dialog' role='document'>
						<div class='modal-content'>
						  ...
						  <div class='modal-body'>
							Are you sure you want to log out ag$index?
						  </div>
						  <div class='modal-footer'>
							<button type='button' class='btn btn-secondary' data-dismiss='modal'>No</button>
							<button type='button' class='btn btn-primary' onclick='resetLastActions($index)' data-dismiss='modal'>Yes</button>
						  </div>
						</div>
					  </div>
					</div>";
		...
		<div class='row mb-12'>
			  ...
			  <div class="col-md-4" align="right">
				 <button type="button" class="btn btn-primary" data-toggle="modal" onclick="resetLastActions('%');location.reload(); " value="%" id="buttonDeleteModal" data-target="#exampleModal">
				 Logout ALL users
				 </button>
			  </div>
		</div>
